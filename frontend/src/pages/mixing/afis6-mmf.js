...
export default function Afis6MmfPage() {
  ...
  const buildPayload = () => ({
    ...
    total_nep_count_g: Number(form.total_nep_count_g) || 0,
    total_nep_mean_size_um: Number(form.total_nep_mean_size_um) || 0,
    cut_length_n_mm: Number(form.cut_length_n_mm) || 0,
    l_n_cv_percent: Number(form.l_n_cv_percent) || 0,
    sfc_n_percent: Number(form.sfc_n_percent) || 0,
    five_pct_l_n_mm: Number(form.five_pct_l_n_mm) || 0,
    fineness_den: Number(form.fineness_den) || 0,
    fineness_cv_percent: Number(form.fineness_cv_percent) || 0,
    long_fiber_gt_46_80_percent: Number(form.long_fiber_gt_46_80_percent) || 0,
    long_fiber_count_gt_46_80: Number(form.long_fiber_count_gt_46_80) || 0,
