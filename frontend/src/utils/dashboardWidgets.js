...
const screenEndpoints = {
  "Quality Control": {
    Mixing: {
      ...
      "AFIS-6 Cotton": "/mixing/afis6-cotton",
      "AFIS-6 MMF": "/mixing/afis6-mmf",
    ...
    Carding: {
      ...
      "Between & Within Data Entry - Within": "/carding/between-within-card",
      "Between & Within Data Entry - Between": "/carding/between-within-card",
      ...
      "Individual Card Waste Study Type 1": "/carding/card-waste-study",
      "Individual Card Waste Study Type 2": "/carding/card-waste-study",
      "Individual Card Waste Study Type 3": "/carding/card-waste-study",
    },
    ...
    Comber: {
      ...
      "Comber Nolis %": "/drawframe/wrapping/comber-noil-percent",
    },
    "Draw Frame": {
      "1 Yard / Half Yard CV Entry": "/drawframe/yarn-cv",
      "Draw Frame Cots Data Entry - Breaker": "/drawframe/cots",
      "Draw Frame Cots Data Entry - Finisher": "/drawframe/cots",
      "U% Data Entry": "/drawframe/uqc",
      "A%": "/drawframe/a-percent",
      "PP - Breaker Drawing": "/drawframe/header",
      "PP - Finisher Drawing": "/drawframe/header",
      "Wheel Change - Breaker Type 1": "/drawframe/wheel-change/type1",
      "Wheel Change - Breaker Type 2": "/drawframe/wheel-change/type2",
      "Wheel Change - Breaker Type 3": "/drawframe/wheel-change/type3",
      "Wheel Change - Finisher Type 1": "/drawframe/wheel-change/finisher-type1-lrsb",
      "Wheel Change - Finisher Type 2": "/drawframe/wheel-change/type2-d40",
      "Wheel Change - Finisher Type 3": "/drawframe/wheel-change/type3-d50-d55",
      "Wheel Change - Finisher Type 4": "/drawframe/wheel-change/type4-ldf3s",
    },
    Simplex: {
      "Process Parameter": "/simplex/process_parameter",
      "SMXCots Checking Data Entry": "/simplex/cots-change",
